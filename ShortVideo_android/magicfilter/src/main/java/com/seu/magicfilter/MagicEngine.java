...
public class MagicEngine {
    ...
    public void stopRecord() {
        ...
        mListener.onVideoRecordFinshedListener();
    }

    private setVideoRecordFinshedListener mListener;

    public interface setVideoRecordFinshedListener {
        void onVideoRecordFinshedListener();
    }

    public void addVideoRecordFinshedListener(setVideoRecordFinshedListener listener){

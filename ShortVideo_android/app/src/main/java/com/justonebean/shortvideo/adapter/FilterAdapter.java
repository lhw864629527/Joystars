...
import com.justonebean.shortvideo.tools.FilterTypeHelper;
...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.FilterHolder> {
    ...
    public void onBindViewHolder(FilterHolder holder, final int position) {
        ...
        if (position == selected) {
            ...
            holder.thumbSelected_bg.setBackgroundColor(context.getResources().getColor(FilterTypeHelper.FilterType2Color(filters[position])));

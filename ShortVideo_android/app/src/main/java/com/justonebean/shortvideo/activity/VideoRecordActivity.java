...
import com.justonebean.shortvideo.adapter.FilterAdapter;
...
public class VideoRecordActivity extends AppCompatActivity implements MagicEngine.setVideoRecordFinshedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        magicEngine.addVideoRecordFinshedListener(this);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.btn_camera_shutter:
                    if (PermissionChecker.checkSelfPermission(VideoRecordActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
                        ActivityCompat.requestPermissions(VideoRecordActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, v.getId());
                    } else {
                        if (mode == MODE_PIC) {
                            takePhoto();
                        } else {
    ...
    public File getOutputMediaFile() {
        File mediaStorageDir = new File(Constants.PhotosDirPath);
    ...
    @Override
    public void onVideoRecordFinshedListener() {
        Toast.makeText(this, "Finished", Toast.LENGTH_SHORT).show();

        Intent intent = new Intent(this, VideoPreviewActivity.class);
        intent.putExtra(Constants.VIDEO_PATH, MagicParams.videoPath + File.separator + MagicParams.videoName);
